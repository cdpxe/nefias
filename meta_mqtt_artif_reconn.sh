...
FILES_WITHCC_OPTIMIZED_QOS_ONE="`/bin/ls recordings/MQTT5_I5/Measurements/WithCC_ASCII/*.csv`"

for recording in $FILES_WITHCC_QOS_NULL $FILES_WITHCC_QOS_ONE $FILES_WITHOUTCC_QOS_NULL $FILES_WITHOUTCC_QOS_ONE $FILES_WITHCC_OPTIMIZED_QOS_ONE; do
